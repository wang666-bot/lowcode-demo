...
var BaseList = exports["default"] = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(BaseList, [{
    ...
    value: function getStyle(index, sticky) {
      ...
      return this.styleCache[index] = sticky ? Object.assign(Object.assign({}, STYLE_STICKY_ITEM), _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _constants.sizeProp[this.scrollDirection], size), _constants.marginProp[this.scrollDirection], offset), _constants.oppositeMarginProp[this.scrollDirection], -(offset + size)), "zIndex", 1)) : Object.assign(Object.assign({}, STYLE_ITEM), _defineProperty(_defineProperty({}, _constants.sizeProp[this.scrollDirection], size), _constants.positionProp[this.scrollDirection], offset));
    }
  }, {
