...
var Link = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  var className = props.className,
    ...
    rest = (0, _tslib.__rest)(props, ["className", "style", "onClick", "onPress", "children", "miniappHref"]);
  var textStyle = {
    color: style.color,
    lines: style.lines,
  ...
  if ((_universalEnv.isMiniApp || _universalEnv.isWeChatMiniProgram) && !_universalEnv.isWeb) {
    ...
    }, /*#__PURE__*/_react["default"].createElement("navigator", Object.assign({
      "open-type": openType,
      url: url,
      className: className,
      style: style
  ...
  return /*#__PURE__*/_react["default"].createElement("a", Object.assign({}, rest, {
    ref: ref,
    className: className,
    style: style,
    onClick: onClick || onPress
  }), typeof children === 'string' ? ( /*#__PURE__*/_react["default"].createElement(_text["default"], {
    style: textStyle
  }, children)) : children);
});
