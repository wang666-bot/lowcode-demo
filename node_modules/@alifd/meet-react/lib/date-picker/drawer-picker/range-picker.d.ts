...
import { LocaleType as DatePickerLocaleType } from '../types';
...
export interface RangePickerProps extends NoLocaleSelectDrawer, LocaledComponentProps<RangePickerLocale> {
    prefix?: string;
    value?: [Date, Date];
...
declare const _default: import("react").ForwardRefExoticComponent<Pick<any, string | number | symbol> & import("react").RefAttributes<RangePickerProps>>;
