...
function isBetween(date, startDate, endDate, unit, intervalMode) {
  if (unit === void 0) {
    unit = 'd';
  }
  if (intervalMode === void 0) {
    intervalMode = '[]';
  }
  return (0, _dayjs.default)(date).isBetween(startDate, endDate, unit, intervalMode);
}
function toDay(from) {
