...
exports.NOW = exports.MIN_MONTH = exports.MIN_DAY = exports.MAX_MONTH = exports.MAX_DAY = exports.DEFAULT_MIN_DATE = exports.DEFAULT_MAX_DATE = void 0;
exports.cloneAsDate = cloneAsDate;
exports.cloneDate = cloneDate;
exports.getAMPM = exports.genTotalPageDates = exports.genContentHeight = exports.formatNumber = void 0;
...
exports.getDateCellStatus = exports.getDateByValues = exports.getDate = exports.getDataSource = void 0;
exports.getDayList = getDayList;
exports.getDefaultFormat = exports.getDaysInMonth = exports.getDays = void 0;
exports.getFirstDayOfMonth = getFirstDayOfMonth;
exports.getMinutes = exports.getMaxMinDate = exports.getHours = void 0;
...
exports.getValues = exports.getTargetDate = exports.getSelectedIndex = exports.getSeconds = void 0;
...
var MAX_MONTH = exports.MAX_MONTH = 11;
var MIN_MONTH = exports.MIN_MONTH = 0;
var MAX_DAY = exports.MAX_DAY = 6;
var MIN_DAY = exports.MIN_DAY = 0;
var NOW = exports.NOW = new Date();
var DEFAULT_MAX_DATE = exports.DEFAULT_MAX_DATE = new Date(NOW.getFullYear() + 20, 11, 31, 23, 59, 59, 999);
var DEFAULT_MIN_DATE = exports.DEFAULT_MIN_DATE = new Date(2000, 0, 1, 0, 0, 0, 0);
var getMaxMinDate = function (validRange) {
...
exports.getMaxMinDate = getMaxMinDate;
var formatNumber = function (value) {
  return value > 9 ? value : "0" + value;
};
exports.formatNumber = formatNumber;
var getDate = function (value, maxDate, minDate) {
...
function updateWeek(d, isAdd, maxDate, minDate) {
  ...
  var newD = (0, _dayjs.default)(d)[isAdd ? 'add' : 'subtract'](1, 'week');
...
function getMonthList(visibleDate, locale) {
  ...
  for (var month = MIN_MONTH; month <= MAX_MONTH; month += 1) {
    months.push({
      label: "" + formatNumber(month + 1) + (locale.month || ''),
...
function isDateSelected(cellDate, selectedData, mode, type) {
  ...
  if (type === 'range') {
    ...
    if (isTheSameDay(cellDate, selectedData[0])) {
      return _types.CellStatusType.begin;
    }
    if (isTheSameDay(cellDate, selectedData[selectedData.length - 1])) {
      return _types.CellStatusType.end;
    }
    return isSelected;
  }
  if (type === 'multi') {
    ...
    for (var i = 0; i < selectedData.length; i++) {
      if (isTheSameDay(cellDate, selectedData[i])) {
        return _types.CellStatusType.selected;
      }
    }
    return isSelected;
  }
  ...
  if (mode === 'month' || mode === 'week') {
    if (isTheSameDay(cellDate, selectedData)) {
      isSelected = _types.CellStatusType.selected;
    }
  }
  if (mode === 'year') {
...
function getCellStatus(cellDate, selectedData, mode, type, disableFunc, maxDate, minDate, view) {
  var cellType = _types.CellStatusType.normal;
  var today = isToday(cellDate);
  if (today) {
    cellType = _types.CellStatusType.today;
  }
  var isInRange = type == 'range' && isDateInRange(cellDate, selectedData);
  if (isInRange) {
    cellType = _types.CellStatusType.range;
  }
...
var getDefaultFormat = function (type, second, use12Hours) {
...
var getDateByValues = function (date, values, type, second, use12Hours) {
  var units = {
...
exports.getDateByValues = getDateByValues;
var getValues = function (value, type, second, use12Hours, maxDate, minDate) {
...
var getYears = function (maxDate, minDate, locale) {
  if (locale === void 0) {
    locale = {};
  }
  var years = [];
...
var getMonths = function (value, maxDate, minDate, locale) {
  if (locale === void 0) {
    locale = {};
  }
  var months = [];
...
var getDays = function (value, maxDate, minDate, locale) {
  if (locale === void 0) {
    locale = {};
  }
  var days = [];
  ...
  for (var day = minDay; day <= maxDay; day += 1) {
    days.push({
      label: "" + formatNumber(day) + (locale.day || ''),
      value: day
    });
  }
  return days;
...
var getHours = function (value, maxDate, minDate, locale, use12Hours) {
  if (locale === void 0) {
    locale = {};
  }
  var hours = [];
  ...
  for (var hour = minHour; hour <= maxHour; hour += 1) {
    hours.push({
      label: "" + formatNumber(hour) + (locale.hour || ''),
      value: hour
    });
  }
  if (use12Hours) {
    ...
    hours = hours.filter(function (item) {
      ...
      if (isPM) {
        ...
        return {
          label: "" + formatNumber(val) + (locale.hour || ''),
          value: item.value
        };
      }
      return item;
...
var getMinutes = function (value, maxDate, minDate, locale) {
  if (locale === void 0) {
    locale = {};
  }
  var minutes = [];
  ...
  for (var minute = minMinute; minute <= maxMinute; minute += 1) {
    minutes.push({
      label: "" + formatNumber(minute) + (locale.minute || ''),
      value: minute
    });
  }
  return minutes;
...
var getSeconds = function (value, maxDate, minDate, locale) {
  if (locale === void 0) {
    locale = {};
  }
  var seconds = [];
  ...
  for (var second = minSecond; second <= maxSecond; second += 1) {
    seconds.push({
      label: "" + formatNumber(second) + (locale.second || ''),
      value: second
    });
  }
  return seconds;
...
var getDataSource = function (value, type, second, use12Hours, maxDate, minDate, locale) {
  value = getDate(value, maxDate, minDate);
  var format = getDefaultFormat(type, second, use12Hours);
  var data = [];
  if (format.indexOf('YYYY') !== -1) {
...
var getTargetDate = function (modeType, visibleDate, type, maxDate, minDate) {
...
var genContentHeight = function (modeType) {
  if (modeType == 'week') {
    return '220';
  }
  if (modeType == 'month') {
...
exports.genContentHeight = genContentHeight;
var genTotalPageDates = function (minDate, maxDate, mode, visibleDate) {
  var dates = [];
...
exports.genTotalPageDates = genTotalPageDates;
var getSelectedIndex = function (dates, selectedDate) {
...
var getDateCellStatus = function (_ref) {
  ...
  if (!isTheSameMonth(cellDate && cellDate.value, visibleDate) && cellType !== _types.CellStatusType.selected && cellType !== _types.CellStatusType.begin && cellType !== _types.CellStatusType.end && cellType !== _types.CellStatusType.range) {
    cellType = _types.CellStatusType.disabled;
  }
  return [cellType, realDisable];
};
exports.getDateCellStatus = getDateCellStatus;