...
var DialogWrapper = function DialogWrapper(props) {
  var onClose = props.onClose,
    onOk = props.onOk,
    others = __rest(props, ["onClose", "onOk"]);
  ...
  var handleClose = function handleClose(reason, e) {
    if (dialogRef === null || dialogRef === void 0 ? void 0 : dialogRef.current) {
      setVisible(false);
    }
    if (onClose) {
      onClose(reason, e);
...
export var show = function show(props) {
  ...
  var _props$onClose = props.onClose,
    onClose = _props$onClose === void 0 ? emptyFn : _props$onClose,
    others = __rest(props, ["onClose"]);
  var hideCurrent = renderToRoot( /*#__PURE__*/React.createElement(DialogWrapper, _extends({
    onClose: onClose
  }, others)));
