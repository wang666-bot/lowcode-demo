...
var Step = function Step(props, ref) {
  ...
  var clses = {
    step: classNames(className, "".concat(clsPrefix), _defineProperty(_defineProperty({}, "".concat(clsPrefix, "--scroll"), isOverflow), "".concat(clsPrefix, "--wechat-").concat(shape), isStrictWechatMiniProgram && direction === 'hoz')),
