...
var Item = function Item(props, ref) {
  ...
  var renderFull = function renderFull() {
    return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(View, {
      className: classNames("".concat(prefix, "breadcrumb-item--action"), _defineProperty(_defineProperty({}, "".concat(prefix, "breadcrumb-item--action-disabled"), disabled || disabledAll), "".concat(prefix, "breadcrumb-item--action-active"), last))
