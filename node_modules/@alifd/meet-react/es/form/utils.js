...
export function getValidationRules(name, options) {
  var validationRules = [];
  var addRule = function addRule(optName, defaultMessage, msgName) {
    if (isUndef(options[optName])) {
      return;
    }
    var r = {};
    r[optName] = options[optName];
    if (defaultMessage) {
      var msgParam = msgName || "".concat(optName, "Message");
    ...
    var trigger = "".concat(optName, "Trigger");
...
export function removeFormAttrs(obj) {
  delete obj.field;
