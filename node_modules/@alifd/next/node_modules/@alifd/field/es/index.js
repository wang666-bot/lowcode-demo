...
import { getValueFromEvent, getErrorStrs, getParams, hasIn, setIn, getIn, deleteIn, mapValidateRules, warning, cloneToRuleArr, isOverwritten, } from './utils';
var initMeta = {
    state: '',
    valueName: 'value',
    trigger: 'onChange',
...
var Field = /** @class */ (function () {
        ...
        if (this.options.autoValidate && autoValidate !== false) {
            ...
            var _loop_1 = function (action) {
                ...
                inputProps[action] = function () {
                    ...
                    _this_1._callNativePropsEvent.apply(_this_1, __spreadArray([action, originalProps], __read(args), false));
    ...
    Field.prototype.setValues = function (fieldsValue, reRender) {
        ...
        if (!this.options.parseName) {
            ...
            var oldFieldValues = fields
                .filter(function (name) { return !isOverwritten(fieldsValue, name); })
        ...
        validate.validate(values, function (errors) {
            ...
            if (errorsGroup) {
                ...
                Object.keys(errorsGroup).forEach(function (i) {
                    ...
                    if (field) {
                        field.errors = getErrorStrs(errorsGroup[i].errors, _this_1.processErrorMessage);
                        field.state = 'error';
                    }
                });
            }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        validate = new Validate(descriptor, {
                            first: this.options.first,
                            messages: this.options.messages,
                        });
    ...
    Field.prototype.addArrayValue = function (name, index) {
        ...
        return this._spliceArrayValue.apply(this, __spreadArray([name, index, 0], __read(argv), false));
    };
    /**
     * 删除指定字段数组内的数据
     * @param name - 变量名
    ...
    Field.prototype._callNativePropsEvent = function (action, props) {
        ...
        action in props &&
            typeof props[action] === 'function' && props[action].apply(props, __spreadArray([], __read(args), false));
    };
    ...
    Field.prototype._validate = function (name, rule, trigger) {
        ...
        validate = new Validate((_a = {}, _a[name] = rule, _a), { messages: this.options.messages });
    ...
    Field.prototype._spliceArrayValue = function (key, index, howmany) {
        ...
        if (p) {
            p.splice.apply(p, __spreadArray([index, howmany], __read(argv), false));
        }
        try {
