...
exports.mockRandomWrapper = mockRandomWrapper;
exports.mockUserChooseMedia = mockUserChooseMedia;
 ...
 * @param globals
 */
function mockLocalStorage(globals) {
  var localStorage = {
    _data: new Map(),
 ...
 * 模拟用户选择媒体文件
 */
function mockUserChooseMedia() {
  var target = new _web.DOMUtil('input[type="file"]');
 ...
 * @param callback
 */
function mockRandomWrapper(_x2) {
  return _mockRandomWrapper.apply(this, arguments);
}
function _mockRandomWrapper() {
  _mockRandomWrapper = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(callback) {
