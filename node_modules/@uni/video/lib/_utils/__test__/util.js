...
exports.createPromisifyImpl = createPromisifyImpl;
exports.isAliContainer = isAliContainer;
exports.noop = exports.mapContainerToGlobalsKey = void 0;
exports.sleep = sleep;
exports.testContainerAPI = testContainerAPI;
exports.testPlatformAPI = testPlatformAPI;
...
exports.mapContainerToGlobalsKey = mapContainerToGlobalsKey;
function createNoop() {
  return function () {};
}
var noop = createNoop();
...
function createPromisifyImpl(value) {
  if (value === void 0) {
    value = {};
  }
...
function isAliContainer(container) {
 ...
 */
function testContainerAPI(container, callback) {
  var map = {
    web: {},
    wechat: {
      wx: {
  ...
  test("Test container: " + container, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
 ...
 * @param callback
 */
function testPlatformAPI(name, containers, callback) {
  describe("Test Platform API: " + name, function () {
    var _loop = function _loop() {
      var container = _step.value;
      testContainerAPI(container, /*#__PURE__*/function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(globals) {
          var configAPI;
...
function testWebAPI(name, callback) {
  describe("Test Platform API: " + name, function () {
    testContainerAPI('web', /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(globals) {
