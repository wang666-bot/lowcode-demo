...
exports.replace = exports.default = void 0;
var _common = require("../common");
var _constant = require("../_utils/constant");
var replace = _common.normalize.replace(function (options) {
  var _ref = options || {},
    url = _ref.url,
  ...
  setTimeout(function () {
    try {
      ...
      if ((url.indexOf('http://') !== -1 || url.indexOf('https://') !== -1) && url.indexOf(location.origin) === -1) {
