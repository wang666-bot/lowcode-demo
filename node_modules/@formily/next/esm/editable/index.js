...
import { useClickAway, usePrefixCls, EditOutlinedIcon, CloseOutlinedIcon, MessageOutlinedIcon, } from '../__builtins__';
...
Editable.Popover = observer(function (props) {
    ...
    return (React.createElement(Balloon, __assign({}, props, { title: field.title, visible: visible, className: props.className, onVisibleChange: function (visible) {
            if (visible) {
                openPopover();
            }
            else {
