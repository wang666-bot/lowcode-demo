...
export var ArrayCards = observer(function (props) {
    ...
    var renderItems = function () {
        return dataSource === null || dataSource === void 0 ? void 0 : dataSource.map(function (item, index) {
            ...
            return (React.createElement(ArrayBase.Item, { key: index, index: index, record: function () { var _a; return (_a = field.value) === null || _a === void 0 ? void 0 : _a[index]; } },
                React.createElement(Card, __assign({ contentHeight: "auto" }, props, { onChange: function () { }, className: cls("".concat(prefixCls, "-item"), props.className), title: title, extra: extra }), content)));
        });
    };
    ...
    var renderEmpty = function () {
        if (dataSource === null || dataSource === void 0 ? void 0 : dataSource.length)
            return;
        return (React.createElement(Card, __assign({ contentHeight: "auto" }, props, { className: cls("".concat(prefixCls, "-item"), props.className), title: props.title || field.title, onChange: function () { } }),
