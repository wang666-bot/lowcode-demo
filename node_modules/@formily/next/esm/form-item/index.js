...
export var BaseItem = function (props) {
    ...
    var _f = __read(useState(false), 2), active = _f[0], setActive = _f[1];
    ...
    var formatChildren = feedbackLayout === 'popover' ? (React.createElement(Balloon, { needAdjust: true, align: "t", closable: false, trigger: children, visible: !!feedbackText },
        React.createElement("div", { className: cls((_a = {},
    ...
    var renderLabelText = function () {
        var labelChildren = (React.createElement("div", { className: cls("".concat(prefixCls, "-label-content")), ref: containerRef },
        ...
        if ((tooltipLayout === 'text' && tooltip) || overflow) {
            return (React.createElement(Balloon.Tooltip, { align: "t", trigger: labelChildren }, getOverflowTooltip()));
        }
        return labelChildren;
    };
    var renderTooltipIcon = function () {
        if (tooltip && tooltipLayout === 'icon' && !overflow) {
            return (React.createElement("span", { className: cls("".concat(prefixCls, "-label-tooltip-icon")) },
                React.createElement(Balloon.Tooltip, { align: "t", trigger: tooltipIcon }, tooltip)));
        }
    };
    ...
    return (React.createElement("div", __assign({}, pickDataProps(props), { style: __assign(__assign({}, style), gridStyles), "data-grid-span": props.gridSpan, className: cls((_b = {},
