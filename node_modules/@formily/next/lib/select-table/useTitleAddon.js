...
var newCheckbox = function (selected, flatDataSource, flatFilteredDataSource, primaryKey, disabled, readOnly, checkStrictly, onChange) {
    return function () {
        ...
        return (react_1.default.createElement(next_1.Checkbox, { key: "titleAddons", disabled: disabled, checked: checked, indeterminate: indeterminate, onChange: onInnerChange }));
    };
};
