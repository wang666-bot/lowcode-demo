...
exports.parseValidator = exports.parseValidatorRules = exports.parseValidatorDescriptions = exports.parseValidatorDescription = void 0;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if ((0, shared_1.isBool)(results)) {
                            if (!results) {
                                return [2 /*return*/, (0, template_1.render)({
                                        type: 'error',
                                        message: message,
                                    }, context_)];
                            }
                            ...
                            if ((0, types_1.isValidateResult)(results)) {
                                return [2 /*return*/, (0, template_1.render)(results, context_)];
                            }
                            return [2 /*return*/, (0, template_1.render)({
                                    type: 'error',
                                    message: results,
