...
exports.compatStage = compatStage;
exports.convertToI18NObject = convertToI18NObject;
exports.deprecate = deprecate;
exports.executePendingFn = executePendingFn;
exports.invariant = invariant;
exports.isFromVC = isFromVC;
exports.isRegExp = isRegExp;
exports.isString = isString;
exports.isUseI18NSetter = isUseI18NSetter;
exports.isVariable = isVariable;
exports.shouldUseVariableSetter = shouldUseVariableSetter;
exports.waitForThing = waitForThing;
...
function convertToI18NObject(v, locale) {
  var _ref;
  if (locale === void 0) {
    locale = 'zh-CN';
  }
  if ((0, _isObject.isI18NObject)(v)) return v;
  return _ref = {
    type: 'i18n',
    use: locale
  }, _ref[locale] = v, _ref;
...
function _innerWaitForThing(obj, path) {
  ...
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      var thing = (0, _lodash.get)(obj, path);
      if (thing) {
...
function executePendingFn(fn, timeout) {
  if (timeout === void 0) {
    timeout = 2000;
  }
