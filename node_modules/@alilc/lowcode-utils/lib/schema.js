...
exports.applyActivities = applyActivities;
exports.compatibleLegaoSchema = compatibleLegaoSchema;
exports.getNodeSchemaById = getNodeSchemaById;
...
function compatibleLegaoSchema(props) {
  ...
  if (!(0, _isPlainObject.isPlainObject)(props)) {
    return props;
  }
  if ((0, _checkTypes.isJSBlock)(props)) {
...
function getNodeSchemaFromPropsById(props, nodeId) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(props); _i < _Object$entries.length; _i++) {
    ...
    if ((0, _checkTypes.isJSSlot)(value)) {
...
function applyActivities(pivotSchema, activities) {
  var schema = (0, _extends2["default"])({}, pivotSchema);
  if (!Array.isArray(activities)) {
    activities = [activities];
  }
  return activities.reduce(function (accSchema, activity) {
    if (activity.type === _lowcodeTypes.ActivityType.MODIFIED) {
    ...
    } else if (activity.type === _lowcodeTypes.ActivityType.ADDED) {
    ...
    } else if (activity.type === _lowcodeTypes.ActivityType.DELETED) {
