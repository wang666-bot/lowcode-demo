...
var TreeMaster = exports.TreeMaster = /*#__PURE__*/function () {
  function TreeMaster(pluginContext, options) {
    ...
    this.initEvent();
    if (pluginContext.registerLevel === _lowcodeTypes.IPublicEnumPluginRegisterLevel.Workspace) {
  ...
  (0, _createClass2["default"])(TreeMaster, [{
    key: "currentTree",
    get: function get() {
