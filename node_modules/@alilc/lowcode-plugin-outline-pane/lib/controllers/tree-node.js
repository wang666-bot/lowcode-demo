...
var TreeNode = exports["default"] = /*#__PURE__*/function () {
  function TreeNode(tree, node) {
    ...
    this.id = (0, _lowcodeUtils.uniqueId)('treeNode');
    this.tree = tree;
  ...
  (0, _createClass2["default"])(TreeNode, [{
    ...
    get: function get() {
      ...
      return loc && this.isResponseDropping() && (0, _lowcodeUtils.isLocationChildrenDetail)(loc.detail) ? loc.detail : null;
    }
  }, {
    key: "depth",
    get: function get() {
