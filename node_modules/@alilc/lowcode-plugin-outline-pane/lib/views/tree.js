...
var TreeView = exports["default"] = /*#__PURE__*/function (_PureComponent) {
  (0, _inheritsLoose2["default"])(TreeView, _PureComponent);
  function TreeView() {
    var _this;
    ...
    _this.onClick = function (e) {
      ...
      if (_this.boostEvent && (0, _lowcodeUtils.isShaken)(_this.boostEvent, e.nativeEvent)) {
        _this.boostEvent = undefined;
        return;
      }
      _this.boostEvent = undefined;
      ...
      if (!(0, _lowcodeUtils.canClickNode)(node, e)) {
        return;
      }
      ...
      if (isMulti && focusNode && !node.contains(focusNode) && selection !== null && selection !== void 0 && selection.has(id)) {
        if (!(0, _lowcodeUtils.isFormEvent)(e.nativeEvent)) {
          selection.remove(id);
        }
      } else {
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React.createElement(_treeNode["default"], {
