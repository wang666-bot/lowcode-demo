 ...
 */
export function generateComponentName(path) {
 ...
 */
export function getNormalizedImportPath(path) {
 ...
 */
export function makeRelativePath(toPath, fromPath) {
 ...
 */
export function resolveAbsoluatePath(path, base) {
  if (!path.startsWith('.')) {
...
export function removeVersion(path) {
