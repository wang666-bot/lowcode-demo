...
exports.isDocumentModel = isDocumentModel;
exports.isPageSchema = isPageSchema;
...
var DocumentModel = exports.DocumentModel = (_dec = _lowcodeEditorCore.obx.shallow, _dec2 = _lowcodeEditorCore.obx.ref, _dec3 = _lowcodeEditorCore.obx.shallow, _dec4 = _lowcodeEditorCore.obx.shallow, _dec5 = _lowcodeEditorCore.obx.ref, _dec6 = _lowcodeEditorCore.obx.ref, _dec7 = _lowcodeEditorCore.obx.ref, (_class = /*#__PURE__*/function () {
  function DocumentModel(project, schema) {
     ...
     * 文档编号
     */
    this.id = (0, _lowcodeUtils.uniqueId)('doc');
    /**
     * 选区控制
     */
    ...
    (0, _initializerDefineProperty2["default"])(this, "nodes", _descriptor, this);
    this.seqId = 0;
    this.emitter = void 0;
     ...
     */
    this._addons = [];
    (0, _initializerDefineProperty2["default"])(this, "_drillDownNode", _descriptor2, this);
    this._modalNode = void 0;
    this._blank = void 0;
    this.inited = false;
    (0, _initializerDefineProperty2["default"])(this, "willPurgeSpace", _descriptor3, this);
    (0, _initializerDefineProperty2["default"])(this, "activeNodes", _descriptor4, this);
    (0, _initializerDefineProperty2["default"])(this, "_dropLocation", _descriptor5, this);
    (0, _initializerDefineProperty2["default"])(this, "_opened", _descriptor6, this);
    (0, _initializerDefineProperty2["default"])(this, "_suspensed", _descriptor7, this);
    ...
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('DocumentModel');
    if (!schema) {
      this._blank = true;
    }
    ...
    this.history = new _history.History(function () {
      return _this["export"](_lowcodeTypes.IPublicEnumTransformStage.Serilize);
    }, function (schema) {
      var _this$simulator;
    ...
    this.modalNodesManager = new _node3.ModalNodesManager(this);
    this.inited = true;
  }
  ...
  _proto.onChangeNodeVisible = function onChangeNodeVisible(fn) {
    var _this$designer$editor,
      _this2 = this;
    (_this$designer$editor = this.designer.editor) === null || _this$designer$editor === void 0 ? void 0 : _this$designer$editor.eventBus.on(_types.EDITOR_EVENT.NODE_VISIBLE_CHANGE, fn);
    return function () {
      var _this2$designer$edito;
      (_this2$designer$edito = _this2.designer.editor) === null || _this2$designer$edito === void 0 ? void 0 : _this2$designer$edito.eventBus.off(_types.EDITOR_EVENT.NODE_VISIBLE_CHANGE, fn);
    };
  };
  _proto.onChangeNodeChildren = function onChangeNodeChildren(fn) {
    var _this$designer$editor2,
      _this3 = this;
    (_this$designer$editor2 = this.designer.editor) === null || _this$designer$editor2 === void 0 ? void 0 : _this$designer$editor2.eventBus.on(_types.EDITOR_EVENT.NODE_CHILDREN_CHANGE, fn);
    return function () {
      var _this3$designer$edito;
      (_this3$designer$edito = _this3.designer.editor) === null || _this3$designer$edito === void 0 ? void 0 : _this3$designer$edito.eventBus.off(_types.EDITOR_EVENT.NODE_CHILDREN_CHANGE, fn);
    };
  };
  ...
  _proto.createNode = function createNode(data) {
    var _schema;
    var schema;
    if ((0, _lowcodeUtils.isDOMText)(data) || (0, _lowcodeUtils.isJSExpression)(data)) {
      schema = {
        componentName: 'Leaf',
        children: data
      };
    ...
    if (!node) {
      node = new _node3.Node(this, schema);
      // will add
      // todo: this.activeNodes?.push(node);
    }
  ...
  _proto.insertNode = function insertNode(parent, thing, at, copy) {
    return (0, _node2.insertChild)(parent, thing, at, copy);
  }
  ...
  _proto.insertNodes = function insertNodes(parent, thing, at, copy) {
    return (0, _node2.insertChildren)(parent, thing, at, copy);
  }
  ...
  _proto.wrapWith = function wrapWith(schema) {
    ...
    if (wrapper.isParental()) {
      ...
      (0, _node2.insertChild)(first.parent, wrapper, first.index);
      (0, _node2.insertChildren)(wrapper, nodes);
  ...
  _proto["import"] = function _import(schema, checkId) {
    ...
    (0, _lowcodeEditorCore.runWithGlobalEventOff)(function () {
      var _this5$rootNode;
      ...
      _this5.modalNodesManager = new _node3.ModalNodesManager(_this5);
  ...
  _proto["export"] = function _export(stage) {
    ...
    if (stage === void 0) {
      stage = _lowcodeTypes.IPublicEnumTransformStage.Serilize;
    }
    ...
    if (Array.isArray(currentSchema === null || currentSchema === void 0 ? void 0 : currentSchema.children) && currentSchema !== null && currentSchema !== void 0 && (_currentSchema$childr = currentSchema.children) !== null && _currentSchema$childr !== void 0 && _currentSchema$childr.length && (currentSchema === null || currentSchema === void 0 ? void 0 : (_currentSchema$childr2 = currentSchema.children) === null || _currentSchema$childr2 === void 0 ? void 0 : _currentSchema$childr2.length) > 0) {
      var FixedTopNodeIndex = currentSchema === null || currentSchema === void 0 ? void 0 : currentSchema.children.filter(function (i) {
        return (0, _lowcodeUtils.isPlainObject)(i);
  ...
  _proto.checkNesting = function checkNesting(dropTarget, dragObject) {
    var _this7 = this;
    var items;
    if ((0, _lowcodeUtils.isDragNodeDataObject)(dragObject)) {
      items = Array.isArray(dragObject.data) ? dragObject.data : [dragObject.data];
    } else if ((0, _lowcodeUtils.isDragNodeObject)(dragObject)) {
      items = dragObject.nodes;
    } else if ((0, _lowcodeUtils.isNode)(dragObject) || (0, _lowcodeUtils.isNodeSchema)(dragObject)) {
      items = [dragObject];
    } else {
  ...
  _proto.checkNestingUp = function checkNestingUp(parent, obj) {
    if ((0, _lowcodeUtils.isNode)(obj) || (0, _lowcodeUtils.isNodeSchema)(obj)) {
      var config = (0, _lowcodeUtils.isNode)(obj) ? obj.componentMeta : this.getComponentMeta(obj.componentName);
      if (config) {
  ...
  _proto.toData = function toData(extraComps) {
    var node = this["export"](_lowcodeTypes.IPublicEnumTransformStage.Save);
    var data = {
  ...
  */
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(this._nodesMap.values()), _step; !(_step = _iterator()).done;) {
      ...
      if (!exsitingMap[_componentName]) {
        ...
        if ((_node$componentMeta = _node.componentMeta) !== null && _node$componentMeta !== void 0 && (_node$componentMeta$n = _node$componentMeta.npm) !== null && _node$componentMeta$n !== void 0 && _node$componentMeta$n["package"]) {
          componentsMap.push((0, _extends2["default"])({}, _node.componentMeta.npm, {
      ...
      extraComps.forEach(function (componentName) {
        if (componentName && !exsitingMap[componentName]) {
          ...
          if (meta !== null && meta !== void 0 && (_meta$npm = meta.npm) !== null && _meta$npm !== void 0 && _meta$npm["package"]) {
            componentsMap.push((0, _extends2["default"])({}, meta === null || meta === void 0 ? void 0 : meta.npm, {
  ...
  (0, _createClass2["default"])(DocumentModel, [{
    key: "simulator",
    get:
    /**
     * 模拟器
    ...
    get: function get() {
      ...
      var selector = _lowcodeEditorCore.engineConfig.get('focusNodeSelector');
...
}(), (_descriptor = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "nodes", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_drillDownNode", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "willPurgeSpace", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "activeNodes", [_dec4], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor5 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_dropLocation", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_opened", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor7 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_suspensed", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "createNode", [_lowcodeEditorCore.action], Object.getOwnPropertyDescriptor(_class.prototype, "createNode"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "import", [_lowcodeEditorCore.action], Object.getOwnPropertyDescriptor(_class.prototype, "import"), _class.prototype)), _class));
