...
exports.Session = exports.History = void 0;
...
var History = exports.History = /*#__PURE__*/function () {
  function History(dataFn, redoer, document) {
    ...
    this.records = void 0;
    this.point = 0;
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('History');
    this.asleep = false;
    ...
    (0, _lowcodeEditorCore.reaction)(function () {
      return dataFn();
    }, function (data) {
      if (_this.asleep) return;
      (0, _lowcodeEditorCore.untracked)(function () {
