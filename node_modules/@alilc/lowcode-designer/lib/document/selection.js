...
var Selection = exports.Selection = (_dec = _lowcodeEditorCore.obx.shallow, (_class = /*#__PURE__*/function () {
  function Selection(doc) {
    this.doc = doc;
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('Selection');
    (0, _initializerDefineProperty2["default"])(this, "_selected", _descriptor, this);
  ...
  _proto.getTopNodes = function getTopNodes(includeRoot) {
    ...
    for (var _iterator3 = _createForOfIteratorHelperLoose(this._selected), _step3; !(_step3 = _iterator3()).done;) {
      ...
      var isTop = true;
      while (i-- > 0) {
        var n = (0, _node3.comparePosition)(nodes[i], _node2);
        // nodes[i] contains node
        if (n === _node3.PositionNO.Contains || n === _node3.PositionNO.TheSame) {
          isTop = false;
          break;
        } else if (n === _node3.PositionNO.ContainedBy) {
  ...
  return Selection;
}(), (_descriptor = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_selected", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
