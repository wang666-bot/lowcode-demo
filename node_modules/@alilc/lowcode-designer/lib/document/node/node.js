...
exports.PositionNO = exports.Node = void 0;
exports.comparePosition = _comparePosition;
exports.contains = _contains;
exports.getZLevelTop = _getZLevelTop;
exports.insertChild = insertChild;
exports.insertChildren = insertChildren;
exports.isLowCodeComponent = isLowCodeComponent;
 ...
 *  hidden
 */
var Node = exports.Node = (_dec = _lowcodeEditorCore.obx.ref, _dec2 = _lowcodeEditorCore.obx.shallow, _dec3 = _lowcodeEditorCore.obx.ref, _dec4 = _lowcodeEditorCore.obx.shallow, (_class = /*#__PURE__*/function () {
  function Node(document, nodeSchema) {
     ...
     */
    this._addons = {};
    (0, _initializerDefineProperty2["default"])(this, "_parent", _descriptor, this);
    this.isInited = false;
    this._settingEntry = void 0;
    this.autoruns = void 0;
    this._isRGLContainer = false;
    this._slotFor = null;
    (0, _initializerDefineProperty2["default"])(this, "_slots", _descriptor2, this);
    /* istanbul ignore next */
    (0, _initializerDefineProperty2["default"])(this, "_conditionGroup", _descriptor3, this);
    this.purged = false;
    this.purging = false;
    ...
    var componentName = nodeSchema.componentName,
      ...
      extras = (0, _objectWithoutPropertiesLoose2["default"])(nodeSchema, _excluded);
    this.id = document.nextId(id);
    this.componentName = componentName;
    if (this.componentName === 'Leaf') {
      this.props = new _props.Props(this, {
        children: (0, _lowcodeUtils.isDOMText)(children) || (0, _lowcodeUtils.isJSExpression)(children) ? children : ''
      });
    } else {
      this.props = new _props.Props(this, props, extras);
      this._children = new _nodeChildren.NodeChildren(this, this.initialChildren(children));
    ...
    this.isInited = true;
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('Node');
    var editor = this.document.designer.editor;
    this.onVisibleChange(function (visible) {
      editor === null || editor === void 0 ? void 0 : editor.eventBus.emit(_types.EDITOR_EVENT.NODE_VISIBLE_CHANGE, _this, visible);
    });
    this.onChildrenChange(function (info) {
      editor === null || editor === void 0 ? void 0 : editor.eventBus.emit(_types.EDITOR_EVENT.NODE_CHILDREN_CHANGE, {
  ...
  _proto.initBuiltinProps = function initBuiltinProps() {
    this.props.has((0, _props.getConvertedExtraKey)('hidden')) || this.props.add(false, (0, _props.getConvertedExtraKey)('hidden'));
    this.props.has((0, _props.getConvertedExtraKey)('title')) || this.props.add('', (0, _props.getConvertedExtraKey)('title'));
    this.props.has((0, _props.getConvertedExtraKey)('isLocked')) || this.props.add(false, (0, _props.getConvertedExtraKey)('isLocked'));
    this.props.has((0, _props.getConvertedExtraKey)('condition')) || this.props.add(true, (0, _props.getConvertedExtraKey)('condition'));
    this.props.has((0, _props.getConvertedExtraKey)('conditionGroup')) || this.props.add('', (0, _props.getConvertedExtraKey)('conditionGroup'));
    this.props.has((0, _props.getConvertedExtraKey)('loop')) || this.props.add(undefined, (0, _props.getConvertedExtraKey)('loop'));
  };
  _proto.initProps = function initProps(props) {
    return this.document.designer.transformProps(props, this, _lowcodeTypes.IPublicEnumTransformStage.Init);
  };
  _proto.upgradeProps = function upgradeProps(props) {
    return this.document.designer.transformProps(props, this, _lowcodeTypes.IPublicEnumTransformStage.Upgrade);
  };
  _proto.setupAutoruns = function setupAutoruns() {
    ...
    this.autoruns = autoruns.map(function (item) {
      return (0, _lowcodeEditorCore.autorun)(function () {
  ...
  _proto.setConditionGroup = function setConditionGroup(grp) {
    ...
    if (!(0, _exclusiveGroup.isExclusiveGroup)(grp)) {
      ...
      if (((_this$prevSibling = this.prevSibling) === null || _this$prevSibling === void 0 ? void 0 : (_this$prevSibling$con = _this$prevSibling.conditionGroup) === null || _this$prevSibling$con === void 0 ? void 0 : _this$prevSibling$con.name) === grp) {
        ...
        _grp = new _exclusiveGroup.ExclusiveGroup(grp);
      }
    }
  ...
  _proto.wrapWith = function wrapWith(schema) {
    var wrappedNode = this.replaceWith((0, _extends2["default"])({}, schema, {
  ...
  _proto.replaceChild = function replaceChild(node, data) {
    ...
    if ((_this$children = this.children) !== null && _this$children !== void 0 && _this$children.has(node)) {
      ...
      if (!(0, _lowcodeUtils.isNode)(newNode)) {
        return null;
      }
  ...
  _proto.onVisibleChange = function onVisibleChange(func) {
    var _this3 = this;
    var wrappedFunc = (0, _lowcodeEditorCore.wrapWithEventSwitch)(func);
  ...
  _proto.getExtraProp = function getExtraProp(key, createIfNone) {
    ...
    return this.props.get((0, _props.getConvertedExtraKey)(key), createIfNone) || null;
  };
  _proto.setExtraProp = function setExtraProp(key, value) {
    var _this$getProp;
    (_this$getProp = this.getProp((0, _props.getConvertedExtraKey)(key), true)) === null || _this$getProp === void 0 ? void 0 : _this$getProp.setValue(value);
  }
  ...
  _proto.setProps = function setProps(props) {
    if (props instanceof _props.Props) {
      this.props = props;
      return;
    }
  ...
  _proto["import"] = function _import(data, checkId) {
    ...
    var componentName = data.componentName,
      ...
      props = data.props,
      extras = (0, _objectWithoutPropertiesLoose2["default"])(data, _excluded2);
    if (this.isSlot()) {
      (0, _tree.foreachReverse)(this.children, function (subNode) {
    ...
    if (this.isParental()) {
      ...
      this.props.get('children', true).setValue((0, _lowcodeUtils.isDOMText)(children) || (0, _lowcodeUtils.isJSExpression)(children) ? children : '');
    }
  };
  ...
  _proto["export"] = function _export(stage, options) {
    ...
    if (stage !== _lowcodeTypes.IPublicEnumTransformStage.Clone) {
      baseSchema.id = this.id;
    }
    if (stage === _lowcodeTypes.IPublicEnumTransformStage.Render) {
    ...
    var _ref = this.props["export"](stage) || {},
      ...
      extras = _ref.extras;
    var _extras_ = (0, _extends2["default"])({}, extras);
    /* istanbul ignore next */
    Object.keys(this._addons).forEach(function (key) {
      var addon = _this4._addons[key];
      if (addon) {
        if (addon.isProp) {
          props[(0, _props.getConvertedExtraKey)(key)] = addon.exportData();
        } else {
          _extras_[key] = addon.exportData();
        }
      }
    });
    var schema = (0, _extends2["default"])({}, baseSchema, {
  ...
  _proto.addSlot = function addSlot(slotNode) {
    ...
    if ((0, _slot.includeSlot)(this, slotName)) {
      (0, _slot.removeSlot)(this, slotName);
    }
  ...
  _proto.onChildrenChange = function onChildrenChange(fn) {
    var _this$children5;
    var wrappedFunc = (0, _lowcodeEditorCore.wrapWithEventSwitch)(fn);
  ...
  (0, _createClass2["default"])(Node, [{
    ...
    get: function get() {
      ...
      return this.props["export"](_lowcodeTypes.IPublicEnumTransformStage.Serilize).props || null;
    }
  }, {
    key: "index",
    get: function get() {
    ...
    key: "schema",
    get: function get() {
      return this["export"](_lowcodeTypes.IPublicEnumTransformStage.Save);
    },
  ...
  return Node;
}(), (_descriptor = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_parent", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "zLevel", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "zLevel"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "title", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "title"), _class.prototype), _descriptor2 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_slots", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "_conditionGroup", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "initBuiltinProps", [_lowcodeEditorCore.action], Object.getOwnPropertyDescriptor(_class.prototype, "initBuiltinProps"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "initProps", [_lowcodeEditorCore.action], Object.getOwnPropertyDescriptor(_class.prototype, "initProps"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "upgradeProps", [_lowcodeEditorCore.action], Object.getOwnPropertyDescriptor(_class.prototype, "upgradeProps"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "componentMeta", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "componentMeta"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "propsData", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "propsData"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "index", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "index"), _class.prototype)), _class));
function ensureNode(node, document) {
  var nodeInstance = node;
  if (!(0, _lowcodeUtils.isNode)(node)) {
...
var PositionNO = exports.PositionNO = /*#__PURE__*/function (PositionNO) {
...
function insertChild(container, thing, at, copy) {
  var node;
  var nodeSchema;
  if ((0, _lowcodeUtils.isNode)(thing) && (copy || thing.isSlot())) {
    var _container$document;
    nodeSchema = thing["export"](_lowcodeTypes.IPublicEnumTransformStage.Clone);
  ...
  } else if ((0, _lowcodeUtils.isNode)(thing)) {
    node = thing;
  } else if ((0, _lowcodeUtils.isNodeSchema)(thing)) {
