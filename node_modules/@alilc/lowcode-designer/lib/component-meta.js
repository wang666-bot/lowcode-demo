...
exports.ensureAList = ensureAList;
exports.isComponentMeta = isComponentMeta;
...
function buildFilter(rule) {
  ...
  if ((0, _lowcodeUtils.isRegExp)(rule)) {
...
var ComponentMeta = exports.ComponentMeta = (_class = /*#__PURE__*/function () {
  function ComponentMeta(designer, metadata) {
    this.designer = designer;
    this.isComponentMeta = true;
    this._npm = void 0;
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('ComponentMeta');
  ...
  _proto.parseMetadata = function parseMetadata(metadata) {
    var componentName = metadata.componentName,
      npm = metadata.npm,
      others = (0, _objectWithoutPropertiesLoose2["default"])(metadata, _excluded);
    ...
    function collectLiveTextEditing(items) {
      items.forEach(function (config) {
        if (config !== null && config !== void 0 && config.items) {
          ...
          if (liveConfig) {
            liveTextEditing.push((0, _extends2["default"])({
  ...
  _proto.transformMetadata = function transformMetadata(metadta) {
    ...
    if (result.experimental && !result.configure.advanced) {
      (0, _lowcodeUtils.deprecate)(result.experimental, '.experimental', '.configure.advanced');
  ...
  _proto.checkNestingUp = function checkNestingUp(my, parent) {
    ...
    if (this.parentWhitelist) {
      return this.parentWhitelist(parent.internalToShellNode(), (0, _lowcodeUtils.isNode)(my) ? my.internalToShellNode() : my);
    }
    return true;
  };
  _proto.checkNestingDown = function checkNestingDown(my, target) {
    ...
    if (this.childWhitelist) {
      ...
      return _target.every(function (item) {
        var _item = !(0, _lowcodeUtils.isNode)(item) ? new _document.Node(my.document, item) : item;
  ...
  (0, _createClass2["default"])(ComponentMeta, [{
    ...
    get: function get() {
      ...
      if ((0, _lowcodeUtils.isTitleConfig)(this._title)) {
        var _this$_title;
    ...
    get: function get() {
      ...
      this.componentName === 'Page' ? _icons.IconPage : this.isContainer ? _icons.IconContainer : _icons.IconComponent);
    }
  }, {
    key: "acceptable",
    get: function get() {
...
}(), ((0, _applyDecoratedDescriptor2["default"])(_class.prototype, "icon", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "icon"), _class.prototype), (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "availableActions", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "availableActions"), _class.prototype)), _class);
