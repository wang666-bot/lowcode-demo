...
var SettingTopEntry = exports.SettingTopEntry = (_class = /*#__PURE__*/function () {
  function SettingTopEntry(editor, nodes) {
    var _this$first$document;
    this.editor = editor;
    this.nodes = nodes;
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('SettingTopEntry');
    this._items = [];
  ...
  _proto.setupItems = function setupItems() {
    ...
    if (this.componentMeta) {
      ...
      this._items = this.componentMeta.configure.map(function (item) {
        ...
        return new _settingField.SettingField(_this, item, settingFieldCollector);
      });
  ...
  _proto.get = function get(propName) {
    ...
    return this._settingFieldMap[propName] || new _settingField.SettingField(this, {
      name: propName
    });
  }
  ...
  (0, _createClass2["default"])(SettingTopEntry, [{
    key: "componentMeta",
    get: function get() {
...
}(), ((0, _applyDecoratedDescriptor2["default"])(_class.prototype, "getValue", [_lowcodeEditorCore.computed], Object.getOwnPropertyDescriptor(_class.prototype, "getValue"), _class.prototype)), _class);
