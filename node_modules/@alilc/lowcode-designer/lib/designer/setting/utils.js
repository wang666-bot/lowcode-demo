...
var Transducer = exports.Transducer = /*#__PURE__*/function () {
  function Transducer(context, config) {
    ...
    if (Array.isArray(setter)) {
      setter = setter[0];
    } else if ( /*#__PURE__*/(0, _react.isValidElement)(setter) && setter.type.displayName === 'MixedSetter') {
    ...
    var isDynamic = true;
    if ((0, _lowcodeUtils.isSetterConfig)(setter)) {
      var _ref = setter,
    ...
    if ((0, _lowcodeUtils.isDynamicSetter)(setter) && isDynamic) {
      try {
