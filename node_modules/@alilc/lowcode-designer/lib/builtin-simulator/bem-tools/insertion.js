...
function processChildrenDetail(sim, container, detail) {
  ...
  if (detail.near) {
    ...
    if (pos === 'replace') {
      ...
      ret.vertical = (0, _designer.isVertical)(ret.nearRect);
    } else {
      ret.insertType = pos;
      ret.vertical = align ? align === 'V' : (0, _designer.isVertical)(ret.nearRect);
    }
    return ret;
  }
...
function processDetail(_ref) {
  ...
  if ((0, _lowcodeUtils.isLocationChildrenDetail)(detail)) {
...
var InsertionView = exports.InsertionView = (0, _lowcodeEditorCore.observer)(_class = /*#__PURE__*/function (_Component) {
  (0, _inheritsLoose2["default"])(InsertionView, _Component);
