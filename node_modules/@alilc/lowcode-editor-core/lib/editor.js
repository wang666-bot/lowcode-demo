...
exports.commonEvent = exports.Editor = void 0;
...
var _assetsTransform = require("./utils/assets-transform");
...
var Editor = exports.Editor = (_dec = _utils.obx.shallow, (_class = /*#__PURE__*/function (_EventEmitter) {
  (0, _inheritsLoose2["default"])(Editor, _EventEmitter);
  function Editor(viewName, workspaceMode) {
    ...
    _this.eventBus = new _eventBus.EventBus((0, _assertThisInitialized2["default"])(_this));
    return _this;
  }
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return Promise.all(remoteComponentDescriptions.map( /*#__PURE__*/function () {
              var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(component) {
                      ...
                      setAssetsComponent = function _setAssetsComponent(component, extraNpmInfo) {
                        ...
                        if (Array.isArray(components)) {
                          components.forEach(function (d) {
                            assets.components = assets.components.concat((0, _extends2["default"])({
          ...
          case 10:
            innerAssets = (0, _assetsTransform.assetsTransform)(assets);
...
var commonEvent = exports.commonEvent = new _eventBus.EventBus(new _events.EventEmitter());