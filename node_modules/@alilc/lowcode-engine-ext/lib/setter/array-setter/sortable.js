...
var Sortable = /*#__PURE__*/function (_Component) {
  (0, _inheritsLoose2["default"])(Sortable, _Component);
  function Sortable() {
    var _this;
  ...
  _proto.render = function render() {
    ...
    var items = [];
    var cards = _react.Children.map(children, function (child) {
      var id = child.key;
      items.push(id);
      return /*#__PURE__*/React.createElement("div", {
        key: id,
        "data-id": id,
        className: (0, _classnames["default"])('lc-sortable-card', itemClassName)
      }, child);
    });
    this.items = items;
    return /*#__PURE__*/React.createElement("div", {
      className: (0, _classnames["default"])('lc-sortable', className),
