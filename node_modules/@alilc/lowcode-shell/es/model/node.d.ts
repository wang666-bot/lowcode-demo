import { INode as InnerNode } from '@alilc/lowcode-designer';
import { IPublicTypeCompositeValue, IPublicTypeNodeSchema, IPublicEnumTransformStage, IPublicModelNode, IPublicTypeIconType, IPublicTypeI18nData, IPublicModelComponentMeta, IPublicModelDocumentModel, IPublicModelNodeChildren, IPublicModelProp, IPublicModelProps, IPublicTypePropsMap, IPublicTypePropsList, IPublicModelSettingTopEntry, IPublicModelExclusiveGroup } from '@alilc/lowcode-types';
import { documentSymbol, nodeSymbol } from '../symbols';
import { ReactElement } from 'react';
export declare class Node implements IPublicModelNode {
    private readonly [documentSymbol];
    private readonly [nodeSymbol];
    private _id;
    /**
     * 节点 id
     */
     ...
     */
    getChildren(): IPublicModelNodeChildren<IPublicModelNode>;
    /**
     * 获取节点实例对应的 dom 节点
     */
    getDOMNode(): any;
