...
var _baseContext = require("./context/base-context");
...
var Workspace = exports.Workspace = (_dec = _lowcodeEditorCore.obx.ref, _dec2 = _lowcodeEditorCore.obx.ref, (_class = /*#__PURE__*/function () {
  function Workspace(registryInnerPlugin, shellModelFactory) {
    ...
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('workspace');
    this._isActive = false;
    this.resourceList = [];
    (0, _initializerDefineProperty2["default"])(this, "windows", _descriptor, this);
    this.editorWindowMap = new Map();
    (0, _initializerDefineProperty2["default"])(this, "window", _descriptor2, this);
    this.windowQueue = [];
    this.context = new _baseContext.BasicContext(this, '', _lowcodeTypes.IPublicEnumPluginRegisterLevel.Workspace);
  ...
  _proto.checkWindowQueue = function checkWindowQueue() {
    ...
    if (windowInfo instanceof _resource.Resource) {
  ...
  _proto.initWindow = /*#__PURE__*/function () {
    var _initWindow = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            resource = new _resource.Resource({
              resourceName: resourceName,
              options: {}
            }, this.defaultResourceType, this);
            this.window = new _window.EditorWindow(resource, this, {
  ...
  _proto.registerResourceType = /*#__PURE__*/function () {
    var _registerResourceType = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(resourceTypeModel) {
      var resourceType;
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            resourceType = new _resourceType.ResourceType(resourceTypeModel);
  ...
  _proto.setResourceList = function setResourceList(resourceList) {
    ...
    this.resourceList = resourceList.map(function (d) {
      return new _resource.Resource(d, _this.getResourceType(d.resourceName), _this);
    });
  ...
  _proto.remove = /*#__PURE__*/function () {
    var _remove = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(index) {
      ...
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            (_this$window = this.window) === null || _this$window === void 0 ? void 0 : _this$window.updateState(_window.WINDOW_STATE.destroyed);
          ...
          case 11:
            this.emitChangeWindow();
            (_this$window3 = this.window) === null || _this$window3 === void 0 ? void 0 : _this$window3.updateState(_window.WINDOW_STATE.active);
          case 13:
          case "end":
  ...
  _proto.openEditorWindowById = /*#__PURE__*/function () {
    var _openEditorWindowById = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(id) {
      ...
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            (_this$window4 = this.window) === null || _this$window4 === void 0 ? void 0 : _this$window4.updateState(_window.WINDOW_STATE.inactive);
            if (!window) {
              _context4.next = 8;
              break;
            }
          ...
          case 7:
            this.emitChangeActiveWindow();
          case 8:
            (_this$window5 = this.window) === null || _this$window5 === void 0 ? void 0 : _this$window5.updateState(_window.WINDOW_STATE.active);
          case 9:
          case "end":
  ...
  _proto.openEditorWindowByResource = /*#__PURE__*/function () {
    var _openEditorWindowByResource = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(resource, sleep) {
      ...
      return _regenerator["default"].wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 4:
            (_this$window7 = this.window) === null || _this$window7 === void 0 ? void 0 : _this$window7.updateState(_window.WINDOW_STATE.inactive);
          ...
          case 14:
            this.emitChangeActiveWindow();
            (_this$window8 = this.window) === null || _this$window8 === void 0 ? void 0 : _this$window8.updateState(_window.WINDOW_STATE.active);
            return _context5.abrupt("return");
          case 17:
            window = new _window.EditorWindow(resource, this, {
              title: resource.title,
          ...
          case 26:
            this.emitChangeWindow();
            this.emitChangeActiveWindow();
            (_this$window9 = this.window) === null || _this$window9 === void 0 ? void 0 : _this$window9.updateState(_window.WINDOW_STATE.active);
          case 29:
          case "end":
  ...
  _proto.openEditorWindow = /*#__PURE__*/function () {
    var _openEditorWindow = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(name, title, options, viewName, sleep) {
      ...
      return _regenerator["default"].wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            return _context6.abrupt("return");
          case 7:
            (_this$window11 = this.window) === null || _this$window11 === void 0 ? void 0 : _this$window11.updateState(_window.WINDOW_STATE.inactive);
            filterWindows = this.windows.filter(function (d) {
              var _d$resource4;
          ...
          case 17:
            this.emitChangeActiveWindow();
            (_this$window12 = this.window) === null || _this$window12 === void 0 ? void 0 : _this$window12.updateState(_window.WINDOW_STATE.active);
            return _context6.abrupt("return");
          case 20:
            resource = new _resource.Resource({
              resourceName: name,
          ...
          case 30:
            this.emitChangeWindow();
            this.emitChangeActiveWindow();
            (_this$window13 = this.window) === null || _this$window13 === void 0 ? void 0 : _this$window13.updateState(_window.WINDOW_STATE.active);
          case 33:
          case "end":
  ...
  return Workspace;
}(), (_descriptor = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "windows", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = (0, _applyDecoratedDescriptor2["default"])(_class.prototype, "window", [_dec2], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
