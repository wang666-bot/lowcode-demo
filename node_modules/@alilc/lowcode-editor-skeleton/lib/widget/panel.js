...
var Panel = exports.Panel = (_dec = _lowcodeEditorCore.obx.ref, _dec2 = _lowcodeEditorCore.obx.ref, _dec3 = _lowcodeEditorCore.obx.ref, (_class = /*#__PURE__*/function () {
  function Panel(skeleton, config) {
    ...
    this.emitter = (0, _lowcodeEditorCore.createModuleEventBus)('Panel');
    this.isPanel = true;
    this.title = void 0;
    this.help = void 0;
    this.plain = false;
  ...
  (0, _createClass2["default"])(Panel, [{
    ...
    get: function get() {
      ...
      return (0, _lowcodeUtils.createContent)(content, (0, _extends2["default"])({}, contentProps, {
        editor: (0, _lowcodeShell.getEvent)(this.skeleton.editor),
        config: this.config,
        panel: this,
        pane: this
      }));
