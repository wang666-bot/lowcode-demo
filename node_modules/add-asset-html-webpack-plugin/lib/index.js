...
function addFileToAssetsWebpack5(filename, compilation) {
  ...
  return (0, _utils.fsReadFileAsync)(resolvedFilename)
  ...
  addFileToAssets(
    ...
    return _asyncToGenerator(function*() {
      ...
      const addFileToAssets =
        ...
        /* istanbul ignore next: webpack 5 not in unit test mocks */
        addFileToAssetsWebpack5;
      const addedFilename = yield addFileToAssets(filepath, compilation);
      let suffix = '';
          ...
          relatedFiles.sort().map(
            /*#__PURE__*/ (function() {
              var _ref = _asyncToGenerator(function*(relatedFile) {
                const addedMapFilename = yield addFileToAssets(
                  relatedFile,
                  compilation
                );
                (0,
